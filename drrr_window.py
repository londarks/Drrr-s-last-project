...
"}")
       ...
       #  self.iconQLabel.setPixmap(QtGui.QPixmap("./img/v2.png"))
        ...
        # self.map_l.setPixmap(QtGui.QPixmap("./img/v2.png"))

        # self.layout_main.addWidget(self.map_l)

        # self.wight.setLayout(self.layout_main)



        #self.item = QListWidgetItem()
        #self.item.setSizeHint(QSize(200, 50)) 



        #add icons
        #self.listWidget.addItem(self.item)
        # self.listWidget.setItemWidget(self.item,self.wight)
        # #setando o layout
...
"}")
    ...
    def loop_msg(self, username, msg):
        ...
        self.layout_right.insertLayout(self.layout_right_down) 
        self.layout_main.insertLayout(self.layout_right)
        self.widget.setLayout(self.layout_main) 
        self.item = QListWidgetItem()
        self.item.setSizeHint(QSize(70, 70))
        self.listWidget.insertItem(0,"   {}".format(username))
